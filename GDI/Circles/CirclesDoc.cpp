...
void CCirclesDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CCirclesDoc::InitializeSearchContent()
{
...
void CCirclesDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
