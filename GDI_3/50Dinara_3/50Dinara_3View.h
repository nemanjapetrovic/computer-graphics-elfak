...
// 50Dinara_3View.h : interface of the CMy50Dinara_3View class
//

#pragma once


class CMy50Dinara_3View : public CView
{
protected: // create from serialization only
	CMy50Dinara_3View();
	DECLARE_DYNCREATE(CMy50Dinara_3View)

// Attributes
public:
	CMy50Dinara_3Doc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in 50Dinara_3View.cpp
inline CMy50Dinara_3Doc* CMy50Dinara_3View::GetDocument() const
   { return reinterpret_cast<CMy50Dinara_3Doc*>(m_pDocument); }
#endif
